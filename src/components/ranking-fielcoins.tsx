      ...
      {players.slice(0, 5).map((player, index) => (
        ...
        >
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <p className="text-xs text-gray-400">{player.points.toLocaleString('pt-BR')} Fielcoins</p>
          </div>
        </div>
      ))}
    </div>
...
export function RankingFielcoins({ players }: { players?: RankedPlayer[] }) {
  return (
